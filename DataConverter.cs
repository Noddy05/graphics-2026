    ...
    internal static class DataConverter
    {
        public static float[] ToFloatArray(params object[] toConvert)
        {
            ...
            foreach(object obj in toConvert) {
                if(obj is Vector2) data.AddRange(ToFloatArray((Vector2)obj));
                if(obj is Vector3) data.AddRange(ToFloatArray((Vector3)obj));
                if(obj is Vector4) data.AddRange(ToFloatArray((Vector4)obj));
                if(obj is Color4)  data.AddRange(ToFloatArray((Color4 )obj));
                if(obj is Matrix4) data.AddRange(ToFloatArray((Matrix4)obj));
            }
